            ...
            >
              <div class="mb-6 shrink-0 flex items-center gap-4">
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <div class="mt-1.5 flex items-center gap-2">
                      <h2 class="min-w-0 truncate text-xl font-bold text-highlighted">{{ entryTitle }}</h2>
                      <button
                        type="button"
                    ...
                    <p class="mt-1 text-xs leading-5 text-muted">Log what you know right now.</p>
                  </div>
                </div>
              ...
              >
                <div
                  ...
                  class="mt-3 overflow-hidden rounded-2xl border border-default bg-elevated"
                >
              ...
              <div class="flex min-h-0 flex-1 flex-col overflow-hidden">
                <div
                  ...
                  class="relative z-10 mb-6 shrink-0 flex items-center justify-between gap-4 bg-default px-1"
                  data-step-swipe-block
                >
                    <button
                      type="button"
                      class="grid size-10 place-items-center rounded-full bg-muted text-highlighted transition hover:bg-accented disabled:opacity-30"
                    ...
                    <div class="min-w-0 flex-1">
                      <p class="text-center text-xs font-bold uppercase tracking-[0.18em] text-muted">
...
const desktopWhatHappened = computed({
  get: () => entryForm.value.what_happened || '',
  set: (value: string) => {
    entryForm.value.what_happened = value
  }
})
...
function saveDesktopQuickEntry() {
  if (!entryForm.value.date_and_time) {
    setEntryDateTimeNow()
  }

  if (!entryForm.value.what_happened?.trim()) {
    entryForm.value.what_happened = entryTitle.value
  }
